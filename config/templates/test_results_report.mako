...
<html lang="en">
    <head>
      ...
      <link href="http://howsthebeach.org/static/css/bootstrap.min.css" rel="stylesheet">
      <link href=http://howsthebeach.org//static/css/css/bootstrap-theme.min.css" rel="stylesheet">

      <title>Folly Beach Water Quality Prediction Results</title>
    </head>
    <body>
        <style>
          .high_bacteria {
        ...
        <div class="container">
            <div class="row">
              <div class="col-xs-12">
                <h1>Folly Beach Water Quality Prediction Results</h1>
            ...
            % for site_data in ensemble_tests:
                ...
                <div class="row">
                    <div class="col-xs-6">
                      <h3>
                        % if str(site_data['models'].ensemble_predicition) == 'LOW':
                          <span>
                        % else:
                          <span class="high_bacteria">
                        % endif
                          Overall Prediction: ${str(site_data['models'].ensemble_predicition)}
                        </span>
                      </h3>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        % for test_obj in site_data['models'].models:
                            ...
                            % endif
                              ...
                              <td>
                                ${test_obj.prediction_level}
                              </td>
                              <td>
                                % if test_obj.result is not None:
                                    % if type(test_obj.result) == bool:
                                        ${str(test_obj.result)}
                                    % else:
                                      ${"%.2f" % (test_obj.result)}
                                    % endif
            ...
            % endfor
            <div class="row">
                <div class="col-xs-6"><h1>Data Used in Models</h1></div>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        % for test_obj in site_data['models'].models:
                            ...
                            % endif
                              ...
                              <td>
                                % for key in test_obj.model_data:
                                  % if test_obj.model_data[key] != -9999:
                                    ${key}: ${test_obj.model_data[key]}
                                  % else:
